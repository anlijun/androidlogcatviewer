...
public final class LogCatFilterSettingsSerializer {
    ...
    private static final String KW_LIST_VALUE = "######";
...
//    private static final String KW_APP = "app";
    ...
    public String encodeToPreferenceString(List<LogCatFilter> filters) {
        ...
        for (LogCatFilter f : filters) {
            ...
            sb.append(KW_NAME); sb.append(KW_DELIM); 
            	sb.append(quoteString(f.getName())); sb.append(ATTR_DELIM);
            sb.append(KW_TAG);  sb.append(KW_DELIM); 
            	sb.append(quoteString(f.getTag())); sb.append(ATTR_DELIM);
            sb.append(KW_TEXT); sb.append(KW_DELIM); 
            	sb.append(quoteString(f.getText())); sb.append(ATTR_DELIM);
            sb.append(KW_PID);  sb.append(KW_DELIM); 
            	sb.append(quoteString(f.getPid())); sb.append(ATTR_DELIM);
