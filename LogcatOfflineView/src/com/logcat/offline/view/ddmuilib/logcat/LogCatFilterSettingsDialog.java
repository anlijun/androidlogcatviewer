...
//        mAppNameFilterText.addModifyListener(m);
        ...
        if ((mPid != null && !mPid.equals("")) || (mTag != null && !mTag.equals(""))){
    ...
    private void createPTGroup(Composite parent){
    	...
    	mTabFolder.setLayout(new GridLayout(2, false));
    	GridData gd = new GridData(GridData.FILL_HORIZONTAL);
    	gd.horizontalSpan = 2;
    	mTabFolder.setLayoutData(gd);
    	
    	TabItem tabI1 = new TabItem(mTabFolder, SWT.NONE);
    	tabI1.setText("Advanced");
    	tabI1.setControl(createTabItem1(mTabFolder));
    	
    	TabItem tabI2 = new TabItem(mTabFolder, SWT.NONE);
    	tabI2.setText("Original");
    	tabI2.setControl(createTabItem2(mTabFolder));
...
//        mAppName = mAppNameFilterText.getText();
        ...
        if (mTabFolder.getSelectionIndex() == 0){
        	mPid = "";
        	mTag = "";
        } else {
        	mPIDHideList.clear();
